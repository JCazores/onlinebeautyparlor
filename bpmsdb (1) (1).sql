...
INSERT INTO `tblappointment` (`ID`, `AptNumber`, `Name`, `Email`, `PhoneNumber`, `AptDate`, `AptTime`, `Services`, `ApplyDate`, `Remark`, `Status`, `RemarkDate`, `Stylist`) VALUES
(1, '149878078', 'jc saminiano', 'saminiano@gmail.com', 912345678, '2025-02-14', '12:00', 'Pedicure', '2025-02-13 00:40:54', '', '', '2025-02-13 01:41:01', 'Mari Chu');
...
(1, 'aboutus', 'About Us', 'Welcome to Rosa Flora Beauty Salon – Where Beauty Meets Excellence\r\n\r\nAt [Rosa Flora Beauty Salon], we believe that beauty is not just about appearances, but about feeling confident, rejuvenated, and truly yourself. Our luxurious, state-of-the-art salon is dedicated to providing exceptional beauty and wellness services in a warm, welcoming environment. Whether you\'re looking for a transformative haircut, a relaxing facial, or a bold new look, our team of skilled professionals is here to help you look and feel your best.', 'rosaflorabeautysalon@gmail.com', NULL, NULL, ''),
